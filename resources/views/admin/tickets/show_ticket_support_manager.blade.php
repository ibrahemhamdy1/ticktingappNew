...
@section('content')
    ...
    <?php
    $users = $role->findOrFail(4)->users()->pluck('name','id');
    ?>
    ...
    <div class="card invoices-card">
        <div class="card-content">
            ...
            {!!Form::submit(('send to sales department'),array('class'=>'btn waves-effect waves-light'))!!}
            {!!Form::close()!!}
@endif
                            ...
                            {!! Form::open(array(
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        <input name="comment"  placeholder="Placeholder" id="comment" type="text" class="validate">
